...
recipe_1 = Recipe.create(title: 'Bread', instructions: '
    Home / Easy Bread Recipes
    EASY HOMEMADE BREAD RECIPE
    PUBLISHED BY JESSICA & NELLIE ON JANUARY 2, 2019
    BEST FALL RECIPES
